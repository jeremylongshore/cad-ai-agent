...
class TestEmptyDrawing:
    ...
    def test_no_grid_layer_entities(self):
        ...
        entities = [
            _entity("1", layer="WALL", entity_type=EntityType.LINE, x=0, y=0,
                    attributes={"end_point": (100, 0)}),
            _entity("2", layer="DOOR", entity_type=EntityType.LINE, x=50, y=50,
...
class TestVerticalLineDetection:
    def test_vertical_line_classified(self):
        ...
        entities = [
            _entity("V1", layer="GRID", entity_type=EntityType.LINE,
                    x=10.0, y=0.0, attributes={"end_point": (10.0, 100.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_multiple_vertical_lines(self):
        entities = [
            _entity("V1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (0.0, 100.0)}),
            _entity("V2", layer="GRID", entity_type=EntityType.LINE,
                    x=30.0, y=0.0, attributes={"end_point": (30.0, 100.0)}),
            _entity("V3", layer="GRID", entity_type=EntityType.LINE,
                    x=60.0, y=0.0, attributes={"end_point": (60.0, 100.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
...
class TestHorizontalLineDetection:
    def test_horizontal_line_classified(self):
        ...
        entities = [
            _entity("H1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=20.0, attributes={"end_point": (100.0, 20.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_multiple_horizontal_lines(self):
        entities = [
            _entity("H1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (100.0, 0.0)}),
            _entity("H2", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=24.0, attributes={"end_point": (100.0, 24.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
...
class TestDiagonalLineSkipped:
    def test_diagonal_not_classified(self):
        ...
        entities = [
            _entity("D1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (100.0, 100.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_diagonal_among_others(self):
        ...
        entities = [
            _entity("V1", layer="GRID", entity_type=EntityType.LINE,
                    x=10.0, y=0.0, attributes={"end_point": (10.0, 100.0)}),
            _entity("D1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (50.0, 50.0)}),
            _entity("H1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=40.0, attributes={"end_point": (100.0, 40.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
...
class TestPolylineDetection:
    def test_vertical_polyline(self):
        ...
        entities = [
            _entity("P1", layer="GRID", entity_type=EntityType.LWPOLYLINE,
                    x=15.0, y=0.0,
    ...
    def test_horizontal_polyline(self):
        ...
        entities = [
            _entity("P2", layer="GRID", entity_type=EntityType.LWPOLYLINE,
                    x=0.0, y=50.0,
...
class TestBayComputation:
    ...
    def test_bay_between_horizontal_lines(self):
        ...
        entities = [
            _entity("H1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (200.0, 0.0)}),
            _entity("H2", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=24.0, attributes={"end_point": (200.0, 24.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_multiple_bays_sorted(self):
        ...
        entities = [
            _entity("V1", layer="GRID", entity_type=EntityType.LINE,
                    x=0.0, y=0.0, attributes={"end_point": (0.0, 100.0)}),
            _entity("V2", layer="GRID", entity_type=EntityType.LINE,
                    x=20.0, y=0.0, attributes={"end_point": (20.0, 100.0)}),
            _entity("V3", layer="GRID", entity_type=EntityType.LINE,
                    x=55.0, y=0.0, attributes={"end_point": (55.0, 100.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
...
class TestLabelExtraction:
    def test_label_from_nearby_text(self):
        ...
        entities = [
            _entity("V1", layer="GRID", entity_type=EntityType.LINE,
                    x=10.0, y=0.0, attributes={"end_point": (10.0, 100.0)}),
            _entity("T1", layer="GRID", entity_type=EntityType.TEXT,
                    x=10.0, y=-10.0, text_content="A"),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_no_label_caveat(self):
        ...
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
        has_label_caveat = any("label" in str(c).lower() or "no label" in str(c).lower()
    ...
    def test_text_too_far_not_used_as_label(self):
        ...
        entities = [
            ...
            _entity("T1", layer="GRID", entity_type=EntityType.TEXT,
                    x=500.0, y=500.0, text_content="Z"),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
...
class TestLayerMatching:
    def test_case_insensitive_grid_layer(self):
        ...
        entities = [
            _entity("V1", layer="grid_lines", entity_type=EntityType.LINE,
                    x=5.0, y=0.0, attributes={"end_point": (5.0, 80.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_column_grid_layer(self):
        ...
        entities = [
            _entity("V1", layer="COLUMN_GRID", entity_type=EntityType.LINE,
                    x=25.0, y=0.0, attributes={"end_point": (25.0, 100.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
    ...
    def test_axis_layer(self):
        ...
        entities = [
            _entity("H1", layer="AXIS", entity_type=EntityType.LINE,
                    x=0.0, y=15.0, attributes={"end_point": (100.0, 15.0)}),
        ]
        ctx = _context(entities)
        analyzer = GridAnalyzer()
        result = analyzer.analyze(ctx, "grid summary")
